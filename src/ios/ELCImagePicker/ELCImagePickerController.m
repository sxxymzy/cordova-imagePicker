...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect) {
        NSString *title = [NSString stringWithFormat:self.maximum_selection_count_error_header, self.maximumImagesCount];
        NSString *message = [NSString stringWithFormat:self.maximum_selection_count_error_message, self.maximumImagesCount];
